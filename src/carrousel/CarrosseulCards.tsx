...
const Carrousel = ({ itens }: CarrouselProps) => {
          ...
          <SwiperSlide key={item.id}>
            <div className="flex flex-col items-center justify-center">
              <div className="bg-[#272727] w-[260px] xxs:w-[280px] h-[330px] lg:w-[308px] lg:h-[360px] rounded-xl shadow-md pb-4 ">
                <div className="flex items-center lg:h-[125px] h-[120px]">
                  <Image
                    src={item.image}
                    alt=""
                    className="rounded-t-xl -4"
                  />
                </div>
                <div className="flex flex-col p-2 h-[160px] justify-around lg:w-[320px] sm:h-[240] lg:h-[180px]">
                  <div className="flex flex-col p-2">
                    <div className="mb-2 ">
                      <h1 className="text-sm lg:text-base font-bold text-neutral ">
                        {t(`${item.title}`)}
                      </h1>
                    </div>
                    <div>
